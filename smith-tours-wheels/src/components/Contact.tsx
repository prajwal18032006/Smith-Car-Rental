          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
              ...
              <Card className="p-6 bg-card-gradient">
                ...
                <div className="space-y-3">
                  ...
                  <Button variant="outline" className="w-full justify-start" size="lg" asChild>
                    <a href="mailto:info@smithtours.com">
            ...
            <Card className="p-8 bg-card-gradient">
              ...
              <form className="space-y-6" onSubmit={e => {
                ...
                const text = `New Inquiry from Smith Tours:%0AName: ${name}%0APhone: ${phone}%0AEmail: ${email}%0AService: ${service}%0ADate: ${date}%0AMessage: ${message}`;
