        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 mb-16">
            {destinations.map((destination, index) => {
              ...
              const whatsappNumber = "919699192585"; // Your WhatsApp number with country code, no plus
                ...
                <Card key={index} className="p-6 bg-card-gradient hover:shadow-medium transition-all duration-300">
                  ...
                  <div className="flex gap-3">
                    <Button 
                      ...
                      className="flex-1"
                      onClick={() => {
                        const text = `*Outstation Trip Booking*%0A%0ADestination: ${place.name}%0ADistance: ${place.distance}%0ADuration: ${place.duration}%0AAttractions: ${place.attractions.join(", ")}%0A%0AI would like to book a trip to ${place.name}.`;
                        const url = `https://wa.me/919699192585?text=${text}`;
                        window.open(url, "_blank");
                        toast({
                          title: "WhatsApp Opening",
                          description: "Redirecting you to WhatsApp to discuss trip details."
                        });
                      }}
                    >
                      Book Trip
            ...
            <Card className="p-8 bg-card-gradient">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button 
                  size="lg"
                  onClick={() => {
                    const text = `*Custom Trip Planning Request*%0A%0AI'm interested in planning a custom trip. Please help me with planning and pricing options.`;
                    const url = `https://wa.me/919699192585?text=${text}`;
                    window.open(url, "_blank");
                    toast({
                      title: "WhatsApp Opening",
                      description: "Redirecting you to WhatsApp to plan your custom trip."
                    });
                  }}
                >
                  Plan Custom Trip
                ...
                <Button 
                  ...
                  variant="outline"
                  onClick={() => {
                    const text = `*Brochure Request*%0A%0AI would like to receive your tour packages brochure with detailed information about destinations and pricing.`;
                    const url = `https://wa.me/919699192585?text=${text}`;
                    window.open(url, "_blank");
                    toast({
                      title: "WhatsApp Opening",
                      description: "Redirecting you to WhatsApp to request our brochure."
                    });
                  }}
                >
                  Request Brochure
